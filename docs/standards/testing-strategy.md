...
| L8 Manual              | Human visual/functional verification. Two procedures no agent can run: `apps/amc-worker/PAPER-CHECK.md` (print, mark, scan) and `apps/server/GOOGLE-CHECK.md` (a real Google login)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | PR checklist                                                                    | Pre-PR                                    |
