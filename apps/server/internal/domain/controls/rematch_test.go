...
func (*matchingReadingStore) ResetRecapturedCopies(context.Context, string, []int) (int, error) {
	return 0, nil
}
func (*matchingReadingStore) ResetScanResults(context.Context, string) error { return nil }
