...
export const pdfEmbedCatalogEntry: CatalogEntry = {
  ...
  whenToUse:
    ...
    'Prefer a <Figure> for an image, and MDX for anything you would otherwise retype: this is the heaviest frame the site embeds — Drive’s viewer costs about 44 requests and 2.8 MB on a first visit, most of it one script (ADR-0076).',
  props: [
    {
      name: 'src',
      type: 'string',
