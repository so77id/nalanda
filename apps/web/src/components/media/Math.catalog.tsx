...
export const mathCatalogEntry: CatalogEntry = {
  ...
  examples: [
    ...
    },
    {
      ...
      render: () => (
        <Math block>{'T(N) = \\begin{cases} c & N = 1 \\\\ T(N-1) + c & N > 1 \\end{cases}'}</Math>
      ),
    },
  ],
};
