...
export const exerciseCatalogEntry: CatalogEntry = {
  ...
  whenToUse:
    ...
    'The class names `NalandaLauncher`, `NalandaCheck` and `NalandaTrace` are reserved: a student program whose MAIN class is one of them is refused before it compiles, with a message saying so (a secondary declaration is not caught — see docs/security-notes.md).',
  props: [
    {
      name: 'title',
      type: 'string',
