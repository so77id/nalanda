...
export const exerciseCatalogEntry: CatalogEntry = {
  ...
  whenToUse:
    ...
    'The class names `NalandaLauncher`, `NalandaCheck` and `NalandaTrace` are reserved: a student program declaring any of them is refused before it compiles, with a message saying so.',
  props: [
    {
      name: 'title',
      type: 'string',
