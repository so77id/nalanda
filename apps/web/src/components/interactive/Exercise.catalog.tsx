...
export const exerciseCatalogEntry: CatalogEntry = {
  ...
  whenToUse:
    ...
    'The editor has no height cap (#294): it renders the whole `starter`, however long, because a slide that promises the complete program has to show it and a projected page cannot be scrolled. The cost is slide scale rather than clipping — a long listing shrinks the whole slide, so measure against the 0.70 floor before shipping one on a slide. The `solution` block keeps its own cap; the two differ on purpose. ' +
