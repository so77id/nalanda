...
export const memoryVisualCatalogEntry: CatalogEntry = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'number[]',
      description:
        'Object ids to paint with a stronger border, so a reader following a walk sees what moved. Optional. <StepShow> may compute this from the difference between adjacent <Step>s; a standalone <MemoryVisual> leaves it empty.',
    },
  ],
  examples: [
    {
