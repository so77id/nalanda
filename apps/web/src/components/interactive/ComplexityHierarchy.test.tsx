...
describe('ComplexityHierarchy', () => {
  ...
  it('marks the row active when the corresponding ring is hovered', () => {
    ...
    // Two classes → two rings. Hover the first rect (deepest = Θ(1))
