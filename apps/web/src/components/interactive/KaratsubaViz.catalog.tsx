...
export const karatsubaVizCatalogEntry: CatalogEntry = {
  ...
  whenToUse:
    ...
    'The recursion is NOT visualised here: the three subproducts (P1, P2, P3) are shown as concrete values. The abstract recursion T(n) = 3T(n/2) + O(n) lives in `<RecursionTreeDivide recipe="karatsuba">` right beside this widget in the deck. ' +
