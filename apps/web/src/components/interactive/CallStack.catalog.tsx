...
export const callStackCatalogEntry: CatalogEntry = {
  ...
  family: 'interactive',
  description:
    'A widget that makes the JVM call stack visible during a recursive execution (ADR-0049). Layout: CodeStepper on the left, stack of frames on the right, growing upward (base at bottom, top at top). Playback is manual by default; the reader steps through the trace with Play / Pause / Step forward / Step back / Reset controls. The `broken` recipe demonstrates StackOverflowError.',
  whenToUse:
